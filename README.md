...
BCIs[@lotte2014; @bottelecocq2014; @blankertz2016; @liyanage2020; @zander2011].
...
useful in everyday situations outside of research contexts
[@dauwels2016; @na2021; @ogino2020]. As BCIs have to react to changes in
...
motion or natural environments rather than in the laboratory
[@jacobsen2020; @debener2012; @devos2014; @devos2014b] . This implicates
...
artifacts, in movement even more than stationary data [@jacobsen2020].
...
data[@chandola2009; @blum2019; @mane2020; @chaudhary2021; @alchalabi2021].
...
[@mullen2015], a statistical method for artifact reduction in EEG. It
...
direct neighbourhood [@mullen2015; @blum2019; @chang2018]. After
...
[@blum2019; @chandola2009; @islam2016]). Nevertheless, the computational
complexity of the method is relatively low, even with large channel
...
powerful PC[@matlab-requirements] and is only available for operating
...
ASR for mobile devices [@van2021], but they aim mainly at field
...
experiments in the past [@dasenbrock2021; @luengen2021; @denk2021].
...
information [@dasenbrock2021; @aroudi2020; @noymai2019]. Its established
...
example the `lsl2ac`-plugin, which converts LSL[@stenner2021] streams
...
from a publicly available data set [@holtze2021] are included in the
